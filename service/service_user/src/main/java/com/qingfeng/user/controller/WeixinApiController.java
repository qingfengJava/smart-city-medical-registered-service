...
import com.qingfeng.user.utils.ConstantWxPropertiesUtil;
import com.qingfeng.user.utils.HttpClientUtils;
 ...
 */
@Controller
@Api(value = "提供微信登录管理的业务接口", tags = "微信登录管理")
